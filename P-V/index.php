...
<body>
        ...
        <div class="row">
            <form id="loginform" method="post">
                <div class="form-row row d-flex justify-content-center">
                    ...
                    <div class="col-auto">
                    <button onclick="test();" class="btn btn-light mb-2" type="button">
    ...
    <div class="container justify-content-center">
            <div id="contenedor" class="justify-content-center">
                <canvas class="lienzo rounded mt-4" width="370" height="370" id="canvasDraw"
                    style="">
        ...
        function catch_click() {
            canvas.addEventListener("mousedown", function(evt) {
                ...
                if(selec_points.length == 0) {
                    var array = [];
                    array.push([Math.round( (x-(x%1))), Math.round( (y-(y%1)))]);
                    localStorage.setItem('selectedPoints', JSON.stringify( array ));
                } else {
                    selec_points.push([Math.round( (x-(x%1))), Math.round( (y-(y%1)))]);
